...
{   /* This is a buffer of double precision floating point values
    ...
    */
    if( argc < 5 ){
      printf("Usage: loopinject <infile.wav|aiff> <loopstart> <loopend> <outfile.wav|aiff>\n");
      exit(1);
    } 
    ...
    */
    ...
    SF_INSTRUMENT inst ;
    inst.loop_count = 1;
    inst.loops[0].start = atoi(argv[2]);
    inst.loops[0].end = atoi(argv[3]);
